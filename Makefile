...
SRC_ALL_DIR			=	$(SRC_DIR) $(SRC_EXEC_DIR) $(SRC_LEXR_DIR) $(SRC_PARS_DIR) $(SRC_TOKS_DIR) $(SRC_SHELL_DIR) $(SRC_SEMATIC_DIR)
...
OBJ_ALL_DIR			= 	$(OBJ_DIR) $(OBJ_EXEC_DIR) $(OBJ_LEXR_DIR) $(OBJ_PARS_DIR) $(OBJ_TOKS_DIR) $(OBJ_SHELL_DIR) $(OBJ_SEMATIC_DIR)
...
INC_ALL_DIR 		= 	$(INC_DIR) $(INC_EXEC_DIR) $(INC_LEXR_DIR) $(INC_PARS_DIR) $(INC_TOKS_DIR) $(INC_SHELL_DIR) $(INC_SEMATIC_DIR)
...
SRCS_ALL 		=	$(SRCS_EXEC) $(SRCS_LEXR) $(SRCS_PARS) $(SRCS_TOKS) $(SRCS_SHELL) $(SRCS_SEMATIC)
OBJS_ALL 		=	$(OBJS_EXEC) $(OBJS_LEXR) $(OBJS_PARS) $(OBJS_TOKS) $(OBJS_SHELL) $(OBJS_SEMATIC)
INCS_ALL 		=	$(INCS_EXEC) $(INCS_LEXR) $(INCS_PARS) $(INCS_TOKS) $(INCS_SHELL) $(INCS_SEMATIC)
