...
# all include which
GLOBAL_INCS		=	$(I_FLAG)$(INC_DIR) $(I_FLAG)$(FT_LIB)/$(FT_INC_DIR) $(I_FLAG)$(INC_EXEC_DIR) $(I_FLAG)$(INC_LEXR_DIR) $(I_FLAG)$(INC_PARS_DIR) $(I_FLAG)$(INC_TOKS_DIR) $(I_FLAG)$(INC_SHELL_DIR) 
...
$(1)/%$(_O): $(2)/%$(_C) $(3)
	@$$(CC) $$(CFLAGS) $$(GLOBAL_INCS) $$(C_FLAG) $$< $$(O_FLAG) $$@
endef
...
$(NAME): $(OBJ_DIR) $(OBJ_ALL_DIR) $(OBJS_ALL)
	@$(CC) $(GLOBAL_INCS) $(CFLAGS) $(O_FLAG) $@ $(OBJS_ALL)  $(L_FLAG)$(FT_LIB) -lft
