...
SRC_ALL_DIR			=	$(SRC_DIR) $(SRC_EXEC_DIR) $(SRC_LEXR_DIR) $(SRC_PARS_DIR) $(SRC_TOKS_DIR) $(SRC_SHELL_DIR) $(SRC_BILTIN_DIR) $(SRC_SEMATIC_DIR)
...
OBJ_ALL_DIR			= 	$(OBJ_DIR) $(OBJ_EXEC_DIR) $(OBJ_LEXR_DIR) $(OBJ_PARS_DIR) $(OBJ_TOKS_DIR) $(OBJ_SHELL_DIR) $(OBJ_BILTIN_DIR) $(OBJ_SEMATIC_DIR)
...
INC_ALL_DIR 		= 	$(INC_DIR) $(INC_EXEC_DIR) $(INC_LEXR_DIR) $(INC_PARS_DIR) $(INC_TOKS_DIR) $(INC_SHELL_DIR) $(INC_BILTIN_DIR) $(INC_SEMATIC_DIR)
